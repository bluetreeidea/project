...
import android.widget.VideoView;
	...
	public class Poston_facebook extends Activity {
	ImageView bck,bck1;
	TextView bck3;
	 String prasi;
   ...
   //     Toast.makeText(Poston_facebook.this, userid , Toast.LENGTH_LONG).show();
      ...
      //  WebSettings settings=web.getSettings();
    	...
    	web.addJavascriptInterface( myJavaScriptInterface, "facebook_native");  	
