...
public class followinglist extends Activity
{
      ...
      //  d=Integer.parseInt("back");
       // d=o.getIntExtra(f, back_btn);
		...
		//	private String sang;
         ...
         webView.addJavascriptInterface( myJavaScriptInterface, "following_native");
         webView.loadUrl("file:///android_asset/www/followinglist.html?user_id="+userid+"&v_id="+vid);
	...
	public class MyJavaScriptInterface {
	   ...
	   public void showOtherProfile(String otherid, String userid){
			   ...
			   Intent i=new Intent(followinglist.this,Other_profile.class);
