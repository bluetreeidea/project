...
public class resediolist extends Activity
{
	WebView webView;
	EditText Msg;
	Button btnSendMsg;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.resediolist);
        Intent o=getIntent();
      ...
      //  d=Integer.parseInt("back");
       // d=o.getIntExtra(f, back_btn);
		...
		//	private String sang;
         ...
         webView.addJavascriptInterface( myJavaScriptInterface, "sedio_native");
         webView.loadUrl("file:///android_asset/www/resedio.html?user_id="+userid+"&v_id="+vid);
	...
	public class MyJavaScriptInterface {
	    ...
	    public void showOtherProfile(String otherid, String userid,String token_fb,String accesskey,String accesstoken){
			   
			   Intent i=new Intent(resediolist.this,Other_profile.class);
