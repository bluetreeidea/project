...
public class likelist extends Activity
{
      ...
      //  d=Integer.parseInt("back");
       // d=o.getIntExtra(f, back_btn);
		...
		//	private String sang;
         ...
         webView.addJavascriptInterface( myJavaScriptInterface, "Like_native");
         webView.loadUrl("file:///android_asset/www/likelist.html?user_id="+userid+"&v_id="+vid);
	...
	public class MyJavaScriptInterface {
	    ...
	    public void showOtherProfile(String otherid, String userid,String token_fb,String accesskey,String accesstoken){
			   ...
			   Intent i=new Intent(likelist.this,Other_profile.class);
